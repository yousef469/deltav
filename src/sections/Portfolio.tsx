...
const portfolioData: PortfolioItem[] = [
    // --- PROGRAMMING: BIG PROJECTS ---
    {
        ...
        subcategory: 'big',
        name: "Atlas",
        shortDesc: "Offline AI Assistant for Engineers, Researchers & Creators",
        longDesc: "Atlas (formerly JARVIS) is a sophisticated, offline-first AI ecosystem designed to provide high-performance assistance without relying on external cloud services. It integrates real-time voice interaction, computer vision, 3D modeling, and automation into a unified cognitive architecture.",
...
*“Precision Engineering. Infinite Intelligence.”*`,
        assets: [
            {
                type: 'video',
                url: '/assets/atlas/video.mp4',
                label: 'Atlas: The AI Who Talks'
            }
        ]
    },
    {
        ...
        subcategory: 'big',
        name: "Nova",
        shortDesc: "Offline Survival & Knowledge Ark (v1.7.1)",
        longDesc: "Nova is a high-resilience, offline-first Android application designed for disaster recovery, long-term survival, and educational preservation. It serves as a decentralized 'Library of Alexandria' and an active emergency response toolkit.",
        image: "/assets/nova/project-overview.jpg",
        link: "#",
        githubLink: "https://github.com/yousef469",
        readme: `# NOVA: The Offline Survival & Knowledge Ark (v1.7.1)
...
**Nova is the definitive tool for the resilient human.** Amaze. 🌌`,
        assets: [
            {
                type: 'video',
                url: '/assets/nova/video.mp4',
                label: 'Offline Ark on Phone'
            }
        ]
    },
    {
